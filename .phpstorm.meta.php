...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/qualchriss/Desktop/nkcng-qual/public/storage' => 'string',
            ...
            'services.africastalking.username' => 'string',
            'services.africastalking.api_key' => 'string',
...
'filesystems.disks.s3.throw','filesystems.links./home/qualchriss/Desktop/nkcng-qual/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'services.ses.region','services.resend.key','services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','services.africastalking.username',
'services.africastalking.api_key','session.driver','session.lifetime','session.expire_on_close','session.encrypt',
...
'filament.exports.download','filament.imports.failed-rows.download','sanctum.csrf-cookie','livewire.update','livewire.upload-file','livewire.preview-file','create-user',
'otp.verification','verify.otp','welcome.page','login-page','login',
'user-logout','loan-approve','store-loan-application','loan-application','loans-pending',
'loans-ongoing','show-loan','loan-packages','loan-payments','repayment-alerts','store-payment','delete-payment','report',
'users','show-user','update-user','delete-user',
'testing','payments.store','assign-gps-device','gps-devices','gps-device.show',
'installations','approve-installation','approve-installation.update',);
        registerArgumentsSet('views', 
'auth.login','auth.registration','auth.verification','components.button.outline','components.icons.bell',
'components.icons.plus','components.logo','components.single-device-map','dashboard.admin','dashboard.customer',
'dashboard.index','dashboard.temp','gps-devices.assign-gps-device','gps-devices.gps-devices','gps-devices.show-gps-device',
'installations.approve-installation','installations.index','layouts.app','layouts.base','layouts.headernav',
'layouts.sidenav','livewire.assign-gps-device','livewire.consent-modal','livewire.create-installations-component','livewire.empty-view',
'livewire.gps-device-table-component','livewire.installations-table-component','livewire.loan-application-form','livewire.loan-approval','livewire.loan-packages',
'livewire.loan-table-component','livewire.location-tracker','livewire.multi-location-tracker','livewire.pending-loans-table','livewire.pie-chart-component',
'livewire.posts-form','livewire.pricing-card','livewire.reports-component','livewire.scheduled-reminder-manager','livewire.show-user-component',
'livewire.test','livewire.test-counter','livewire.test-msg','livewire.testing-component','livewire.testmodal',
'livewire.udp-messages','livewire.user-index','livewire.user-location-tracker','livewire.vehicle-gps','livewire::pagination-links',
'loan.application','loan.loan-packages','loan.loan-payments','loan.ongoing','loan.pending-loans',
'loan.repayment-alerts','loan.show-loan','loan.temp','misc.testing','pagination::bootstrap-4',
...
'pagination::simple-default','pagination::simple-tailwind','pagination::tailwind','report.daily','users.index',
'users.show-user','vendor.livewire.pagination-links','vendor.pagination.bootstrap-4','vendor.pagination.bootstrap-5','vendor.pagination.default',
...
'vendor.pagination.tailwind','welcome','filament-actions::badge-action','filament-actions::badge-group','filament-actions::button-action',
...
'filament-notifications::database-notifications','filament-notifications::notification','filament-notifications::notifications','filament::assets','filament::components.actions',
...
'APP_URL','SMS_API_KEY','APP_LOCALE','APP_FALLBACK_LOCALE','APP_FAKER_LOCALE',
'APP_MAINTENANCE_DRIVER','APP_MAINTENANCE_STORE','AFRICASTALKING_USERNAME','AFRICASTALKING_API_KEY','BCRYPT_ROUNDS',
...
'SESSION_SECURE_COOKIES','BROADCAST_CONNECTION','FILESYSTEM_DISK','QUEUE_CONNECTION','CACHE_STORE',
'CACHE_PREFIX','MEMCACHED_HOST','REDIS_CLIENT','REDIS_HOST','REDIS_PASSWORD',
'REDIS_PORT','MAPBOX_ACCESS_TOKEN','MAIL_MAILER','MAIL_HOST','MAIL_PORT',
...
'VITE_APP_NAME','VITE_API_BASE_URL','BROADCAST_DRIVER','PUSHER_APP_ID','PUSHER_APP_KEY',
