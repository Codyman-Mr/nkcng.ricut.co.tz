    ...
    public function render()
    {
        ...
        $loanStatus = [
            ...
            'repaid' => Loan::leftJoin(table: 'payments', first: 'loans.id', operator: '=', second: 'payments.loan_id')
                ...
                ->groupBy('loans.id', 'loans.loan_required_amount') // Include `loan_required_amount` in GROUP BY
            ...
            'overdue' => Loan::leftJoin('payments', 'loans.id', '=', 'payments.loan_id')
                ...
                ->groupBy('loans.id', 'loans.loan_required_amount', 'loans.loan_end_date') // Include `loan_required_amount` and `due_date` in GROUP BY
